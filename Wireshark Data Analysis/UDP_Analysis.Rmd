...
plot1_ns3 <- ggplot(data=data_ns3, aes(x=Time, y=Delay_UDP)) + geom_point(color="firebrick") + labs(x = "Czas [s]", y = "Opóźnienie [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Opóźnienie NS3") + stat_smooth(method = 'lm')

plot2_ns3 <- ggplot(data=data_ns3, aes(x=Time, y=Jitter)) + geom_point(color="firebrick") + labs(x = "Czas [s]", y = "Jitter [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Jitter NS3")+ stat_smooth(method = 'lm')
...
plot1_ns3mn <- ggplot(data=data_ns3mn, aes(x=Time, y=Delay_UDP)) + geom_point(color="firebrick") + labs(x = "Czas [s]", y = "Opóźnienie [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Opóźnienie NS3-Mininet") + stat_smooth(method = 'lm')

plot2_ns3mn <- ggplot(data=data_ns3mn, aes(x=Time, y=Jitter)) + geom_point(color="firebrick") + labs(x = "Czas [s]", y = "Jitter [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Jitter NS3-Mininet")+ stat_smooth(method = 'lm')
