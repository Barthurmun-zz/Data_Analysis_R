...
data_ns3mn <- read.csv(file="Scen3NS3MN_RTT.csv", col.names = 
                   c("No.", "Time", "Source", "Destination", "Protocol", 
                     "Lenght", "Delay_TCP", "Delay_UDP","Priority", "ACK RTT","Source Port", "Destination Port","Info","New Column"))
...
plot1_ns3 <- ggplot(data=data_ns3, aes(x=Time, y=ACK.RTT)) + geom_line(color="darkseagreen")+geom_point(color="firebrick") + labs(x = "Czas [s]", y = "RTT [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Przykładowy pomiar RTT dla TCP")
...
plot2_ns3 <- ggplot(data=data_ns3, aes(x=Time, y=Jitter)) + geom_line(color="darkseagreen")+geom_point(color="firebrick") + labs(x = "Czas [s]", y = "Jitter [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Jitter NS3")
...
plot1_ns3mn <- ggplot(data=data_ns3mn, aes(x=Time, y=ACK.RTT)) + geom_line(color="darkseagreen")+geom_point(color="firebrick") + labs(x = "Czas [s]", y = "RTT [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Opóźnienie NS3-Mininet")

plot2_ns3mn <- ggplot(data=data_ns3mn, aes(x=Time, y=Jitter)) + geom_line(color="darkseagreen")+geom_point(color="firebrick") + labs(x = "Czas [s]", y = "Jitter [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Jitter NS3-Mininet")
...
```{r}
#NS3
plot3_ns3 <- ggplot(data=data3_ns3, aes(x=Time, y=`ACK RTT`)) + geom_line(color="darkseagreen")+geom_point(color="firebrick") + labs(x = "Czas [s]", y = "RTT [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Uśrednione opóźnienie NS3")

plot4_ns3 <- ggplot(data=data3_ns3, aes(x=Time, y=Jitter)) + geom_line(color="darkseagreen")+geom_point(color="firebrick") + labs(x = "Czas [s]", y = "Jitter [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Uśredniony jitter NS3")
...
```{r}
#NS3-Mininet
plot3_ns3mn <- ggplot(data=data3_ns3mn, aes(x=Time, y=`ACK RTT`)) + geom_line(color="darkseagreen")+geom_point(color="firebrick") + labs(x = "Czas [s]", y = "RTT [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Uśrednione opóźnienie NS3")

plot4_ns3mn <- ggplot(data=data3_ns3mn, aes(x=Time, y=Jitter)) + geom_line(color="darkseagreen")+geom_point(color="firebrick") + labs(x = "Czas [s]", y = "Jitter [ms]") + theme(axis.title.x = element_text(color = "black", size = 12, vjust = 0.35), axis.title.y = element_text(color = "black", size = 12, vjust = 0.35)) + ggtitle("Uśredniony jitter NS3")
